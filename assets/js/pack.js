(() => {
	var e, o = {
		984: (e, o, i) => {
			...
			var n = i(169),
				a = i(682),
				r = (i(429), ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])']),
				t = r.join(","),
			...
			function m(e, o) {
				...
				for (o.includeContainer && s.call(e, t) && (d = Array.prototype.slice.apply(d)).unshift(e), i = 0; i < d.length; i++) c(n = d[i]) && (0 === (a = u(n)) ? r.push(n) : m.push({
					documentOrder: i,
					tabIndex: a,
					node: n
				}));
				return m.sort(l).map((function (e) {
					return e.node
				})).concat(r)
			}
			...
			m.isTabbable = function (e) {
				if (!e) throw new Error("No node provided");
				return !1 !== s.call(e, t) && c(e)
			}, m.isFocusable = function (e) {
				if (!e) throw new Error("No node provided");
				return !1 !== s.call(e, g) && d(e)
			};
			var g = r.concat("iframe").join(",");
			...
			var f, y, h = m,
				...
				b = (y = [], {
					activateTrap: function (e) {
						...
						var i = y.indexOf(e); - 1 === i || y.splice(i, 1), y.push(e)
					},
			...
			function M(e) {
				return E(z(e)).left + S(e).scrollLeft
			}
			...
			function T(e, o, i) {
				...
				return i || (("body" !== A(o) || P(r)) && (s = (n = o) !== C(n) && I(n) ? {
					scrollLeft: (a = n).scrollLeft,
					scrollTop: a.scrollTop
				} : S(n)), I(o) ? ((m = E(o)).x += o.clientLeft, m.y += o.clientTop) : r && (m.x = M(r))), {
			...
			function N(e) {
				return "html" === A(e) ? e : e.assignedSlot || e.parentNode || e.host || z(e)
			}

			function B(e, o) {
				void 0 === o && (o = []);
				var i = function e(o) {
					return ["html", "body", "#document"].indexOf(A(o)) >= 0 ? o.ownerDocument.body : I(o) && P(o) ? o : e(N(o))
				}(e),
					n = "body" === A(i),
					a = C(i),
					r = n ? [a].concat(a.visualViewport || [], P(i) ? i : []) : i,
					t = o.concat(r);
				return n ? t : t.concat(B(N(r)))
			}
			...
			function F(e) {
				for (var o = C(e), i = D(e); i && q(i);) i = D(i);
				return i && "body" === A(i) && "static" === L(i).position ? o : i || o
			}
			k.TinyEmitter = x;
			var R = "top",
				V = "bottom",
				...
				W = "left",
				K = [R, V, H, W],
				U = K.reduce((function (e, o) {
					return e.concat([o + "-start", o + "-end"])
				}), []),
				J = [].concat(K, ["auto"]).reduce((function (e, o) {
			...
			function ne(e) {
				...
				if (m) {
					var h = F(i);
					h === C(i) && (h = z(i)), a === R && (f = V, g -= h.clientHeight - n.height, g *= s ? 1 : -1), a === W && (v = H, d -= h.clientWidth - n.width, d *= s ? 1 : -1)
				}
				var j, p = Object.assign({
					position: t
				}, m && ie);
				return s ? Object.assign({}, p, ((j = {})[f] = l ? "0" : "", j[v] = u ? "0" : "", j.transform = (y.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + g + "px)" : "translate3d(" + d + "px, " + g + "px, 0)", j)) : Object.assign({}, p, ((o = {})[f] = l ? g + "px" : "", o[v] = u ? d + "px" : "", o.transform = "", o))
			}
			var ae = {
				left: "right",
				right: "left",
			...
			function ge(e, o) {
				return "viewport" === o ? de(function (e) {
					var o = C(e),
						i = o.visualViewport,
						n = o.innerWidth,
						a = o.innerHeight;
			...
			function ue(e, o, i) {
				var n = "clippingParents" === o ? function (e) {
					var o = B(e),
						i = ["absolute", "fixed"].indexOf(L(e).position) >= 0 && I(e) ? F(e) : e;
					return O(i) ? o.filter((function (e) {
						return O(e) && ce(e, i)
					})) : []
				}(e) : [].concat(o),
					a = [].concat(n, [i]),
			...
			function fe(e, o) {
				...
				var i = o,
					...
					l = i.padding,
					v = void 0 === l ? 0 : l,
					f = le("number" != typeof v ? v : ve(v, K)),
					y = "popper" === d ? "reference" : "popper",
					h = e.elements.reference,
					j = e.rects.popper,
					p = e.elements[u ? y : d],
					b = ue(O(p) ? p : p.contextElement || z(e.elements.popper), t, m),
					w = E(h),
					k = oe({
						reference: w,
						element: j,
				...
				if ("popper" === d && I) {
					...
					Object.keys(S).forEach((function (e) {
						var o = [H, V].indexOf(e) >= 0 ? 1 : -1,
							i = [R, V].indexOf(e) >= 0 ? "y" : "x";
						S[e] += A[i] * o
					}))
				}
				return S
			...
			function je(e) {
				return [R, H, V, W].some((function (o) {
					return e[o] >= 0
				}))
			}
			var pe = function (e) {
					...
					var a, t, s = {
						...
						d = {
							...
							setOptions: function (i) {
								g(), s.options = Object.assign({}, r, {}, s.options, {}, i), s.scrollParents = {
									reference: O(e) ? B(e) : e.contextElement ? B(e.contextElement) : [],
									popper: B(o)
								};
							...
							forceUpdate: function () {
								if (!c) {
									...
									if (Y(o, i)) {
										s.rects = {
											reference: T(o, F(i), "fixed" === s.options.strategy),
											popper: _(i)
				...
				defaultModifiers: [{
					...
					effect: function (e) {
						...
						})), s && m.addEventListener("resize", i.update, Z),
							function () {
								r && c.forEach((function (e) {
									e.removeEventListener("scroll", i.update, Z)
								})), s && m.removeEventListener("resize", i.update, Z)
							}
					},
					data: {}
				}, {
					...
					fn: function (e) {
						var o = e.state,
							...
							t = void 0 === r || r,
							s = {
								placement: X(o.placement),
								popper: o.elements.popper,
								popperRect: o.rects.popper,
								gpuAcceleration: a
							};
						null != o.modifiersData.popperOffsets && (o.styles.popper = Object.assign({}, o.styles.popper, {}, ne(Object.assign({}, s, {
							offsets: o.modifiersData.popperOffsets,
							position: o.options.strategy,
							adaptive: t
						})))), null != o.modifiersData.arrow && (o.styles.arrow = Object.assign({}, o.styles.arrow, {}, ne(Object.assign({}, s, {
					...
					fn: function (e) {
						...
						Object.keys(o.elements).forEach((function (e) {
							var i = o.styles[e] || {},
								n = o.attributes[e] || {},
								a = o.elements[e];
							I(a) && A(a) && (Object.assign(a.style, i), Object.keys(n).forEach((function (e) {
								var o = n[e];
						...
						return Object.assign(o.elements.popper.style, i.popper), o.elements.arrow && Object.assign(o.elements.arrow.style, i.arrow),
							function () {
								Object.keys(o.elements).forEach((function (e) {
									...
									I(n) && A(n) && (Object.assign(n.style, r), Object.keys(a).forEach((function (e) {
										n.removeAttribute(e)
									})))
								}))
							}
						...
						var o = e.state,
							...
							t = J.reduce((function (e, i) {
								return e[i] = function (e, o, i) {
									var n = X(e),
										a = [W, R].indexOf(n) >= 0 ? -1 : 1,
										r = "function" == typeof i ? i(Object.assign({}, o, {
											placement: e
										})) : i,
										t = r[0],
										s = r[1];
									return t = t || 0, s = (s || 0) * a, [W, H].indexOf(n) >= 0 ? {
										x: s,
										y: t
									} : {
										x: t,
					...
					fn: function (e) {
						...
						if (!o.modifiersData[n]._skip) {
							for (var a = i.mainAxis, r = void 0 === a || a, t = i.altAxis, s = void 0 === t || t, m = i.fallbackPlacements, c = i.padding, d = i.boundary, g = i.rootBoundary, u = i.altBoundary, l = i.flipVariations, v = void 0 === l || l, f = i.allowedAutoPlacements, y = o.options.placement, h = X(y), j = m || (h !== y && v ? function (e) {
								if ("auto" === X(e)) return [];
								var o = re(e);
								return [se(e), o, se(o)]
							}(y) : [re(y)]), p = [y].concat(j).reduce((function (e, i) {
								return e.concat("auto" === X(i) ? function (e, o) {
									void 0 === o && (o = {});
									var i = o,
										n = i.placement,
										a = i.boundary,
								...
								var P = re(L),
									T = [];
								if (r && T.push(M[O] <= 0), s && T.push(M[L] <= 0, M[P] <= 0), T.every((function (e) {
									return e
								}))) {
									E = S, x = !1;
									break
						...
						if (k) {
							if (r) {
								var O = "y" === b ? R : W,
									...
									D = o.modifiersData["arrow#persistent"] ? o.modifiersData["arrow#persistent"].padding : {
										top: 0,
										right: 0,
										bottom: 0,
										left: 0
									...
									U = D[I],
									J = ye(0, x[A], q[A]),
									G = p ? x[A] / 2 - P - J - K - C : T - J - K - C,
									$ = p ? -x[A] / 2 + P + J + U + C : N + J + U + C,
									Y = o.elements.arrow && F(o.elements.arrow),
									Z = Y ? "y" === b ? Y.clientTop || 0 : Y.clientLeft || 0 : 0,
									oe = o.modifiersData.offset ? o.modifiersData.offset[o.placement][b] : 0,
									ie = k[b] + G - oe - Z,
									ne = k[b] + $ - oe,
									ae = ye(l ? Math.min(M, ie) : M, z, l ? Math.max(L, ne) : L);
								k[b] = ae, S[b] = ae - z
							}
							if (s) {
								var re = "x" === b ? R : W,
					...
					fn: function (e) {
						var o, i = e.state,
							...
							t = X(i.placement),
							s = ee(t),
							m = [W, H].indexOf(t) >= 0 ? "height" : "width";
						if (a && r) {
					...
					effect: function (e) {
						var o = e.state,
							...
							t = i.padding,
							s = void 0 === t ? 0 : t;
						null != r && ("string" != typeof r || (r = o.elements.popper.querySelector(r))) && ce(o.elements.popper, r) && (o.elements.arrow = r, o.modifiersData[n + "#persistent"] = {
							padding: le("number" != typeof s ? s : ve(s, K))
						})
					},
					requires: ["popperOffsets"],
				...
				be = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0 !== i.g ? i.g : "undefined" != typeof self ? self : {},
				we = be.location || {},
				ke = function () {
					var e = {
					...
					function g(e, o) {
						for (var n, a, r, s, c, g, u, l, v, f, y, h, j, p = function e(o, i) {
							...
							for (r = !1, s = document.createDocumentFragment(), g = (c = p[b]).nodeValue, l = 0; u = i.exec(g);) {
								if ((v = u.index) !== l && s.appendChild(m(g.slice(l, v), !0)), h = d(y = u[0]), l = v + y.length, j = o.callback(h, o), h && j) {
							...
							r && (l < g.length && s.appendChild(m(g.slice(l), !0)), c.parentNode.replaceChild(s, c))
						}
						return e
					}
			...
			we.protocol || (ke.base = ke.base.replace(/^http:/, ""));
			var xe = ke,
				Ee = {
			...
			class Ae {
				...
				render() {
					const e = Ce("div", "emoji-picker__preview");
					return this.emoji = Ce("div", "emoji-picker__preview-emoji"), e.appendChild(this.emoji), this.name = Ce("div", "emoji-picker__preview-name"), e.appendChild(this.name), this.events.on("showPreview", (e => this.showPreview(e))), this.events.on("hidePreview", (() => this.hidePreview())), e
				}
				showPreview(e) {
					let o = e.emoji;
					e.custom ? o = `<img class="emoji-picker__custom-emoji" src="${e.emoji}">` : "twemoji" === this.options.style && (o = xe.parse(e.emoji, Ie)), this.emoji.innerHTML = o, this.name.innerHTML = e.name
				}
				hidePreview() {
			...
			try {
				"undefined" != typeof window && (Te = window), "undefined" != typeof document && (_e = document), "undefined" != typeof MutationObserver && MutationObserver, "undefined" != typeof performance && (Ne = performance)
			} catch (r) { }
			var Be = (Te.navigator || {}).userAgent,
				qe = void 0 === Be ? "" : Be,
				De = Te,
				Fe = _e,
				Re = Ne,
				Ve = (De.document, !!Fe.documentElement && !!Fe.head && "function" == typeof Fe.addEventListener && "function" == typeof Fe.createElement),
				He = (~qe.indexOf("MSIE") || qe.indexOf("Trident/"), "group"),
				We = De.FontAwesomeConfig || {};
			...
			var Ue = Me({}, Ke);
			De.FontAwesomeConfig = Ue;
			var Je = De || {};
			Je.___FONT_AWESOME___ || (Je.___FONT_AWESOME___ = {}), Je.___FONT_AWESOME___.styles || (Je.___FONT_AWESOME___.styles = {}), Je.___FONT_AWESOME___.hooks || (Je.___FONT_AWESOME___.hooks = {}), Je.___FONT_AWESOME___.shims || (Je.___FONT_AWESOME___.shims = []);
			var Ge = Je.___FONT_AWESOME___,
				Xe = [];
			...
			}))), void 0 !== i.g && void 0 !== i.g.process && i.g.process.emit, "undefined" == typeof setImmediate ? setTimeout : setImmediate;
			var $e = {
				size: 16,
				x: 0,
				y: 0,
			...
			function ao(e) {
				var o = e.icons,
					...
					j = [Ue.replacementClass, r ? "".concat(Ue.familyPrefix, "-").concat(r) : "", h].filter((function (e) {
						return -1 === g.classes.indexOf(e)
					})).concat(g.classes).join(" "),
					p = {
						children: [],
						attributes: Me({}, g.attributes, {
							"data-prefix": a,
							"data-icon": r,
							class: j,
				...
				var b = Me({}, p, {
					...
					w = n.found && i.found ? function (e) {
						var o, i = e.children,
							...
							f = {
								tag: "g",
								attributes: Me({}, u.inner),
								children: [no(Me({
									tag: c.tag,
									attributes: Me({}, c.attributes, u.path)
								}, v))]
							},
							y = {
								tag: "g",
								attributes: Me({}, u.outer),
								children: [f]
							},
							h = "mask-".concat(t || Ye()),
							j = "clip-".concat(t || Ye()),
				...
				return b.children = k, b.attributes = x, s ? function (e) {
					...
					return [{
						...
						children: [{
							tag: "symbol",
							attributes: Me({}, a, {
								id: !0 === r ? "".concat(o, "-").concat(Ue.familyPrefix, "-").concat(i) : r
							}),
							children: n
						}]
					}]
			...
			var ro = (Ue.measurePerformance && Re && Re.mark && Re.measure, function (e, o, i, n) {
			...
			function uo(e) {
				...
				}(n), ">").concat(r.map(uo).join(""), "</").concat(o, ">")
			}
			...
			function ho(e) {
				...
				return {
					...
					icon: Array.isArray(n) ? {
						tag: "g",
						attributes: {
							class: "".concat(Ue.familyPrefix, "-").concat(He)
						},
						children: [{
							tag: "path",
							attributes: {
								class: "".concat(Ue.familyPrefix, "-").concat("secondary"),
								fill: "currentColor",
								d: n[0]
							}
						}, {
							tag: "path",
							attributes: {
								class: "".concat(Ue.familyPrefix, "-").concat("primary"),
								fill: "currentColor",
								d: n[1]
							}
						}]
			...
			function bo(e) {
				var o = e.prefix,
					i = void 0 === o ? "fa" : o,
					n = e.iconName;
				if (n) return go(ko.definitions, i, n) || go(Ge.styles, i, n)
			}
			Me({}, vo, {
				cx: "256",
				cy: "364",
				...
				Eo = (wo = function (e) {
					...
					if (e) {
						...
						return po(Me({
							...
							return jo(), Ue.autoA11y && (g ? h["aria-labelledby"] = "".concat(Ue.replacementClass, "-title-").concat(l || Ye()) : (h["aria-hidden"] = "true", h.focusable = "false")), ao({
								icons: {
									main: ho(k),
									mask: s ? ho(s.icon) : {
										found: !1,
			...
			class Vo {
				...
				render() {
					const e = Ce("div", "emoji-picker__container");
						...
						return function u(l) {
							var v = {
								single: function (e, o, i) {
									return e ? (c(e) || (e = v.getPreparedSearch(e)), o ? (c(o) || (o = v.getPrepared(o)), ((i && void 0 !== i.allowTypo ? i.allowTypo : !l || void 0 === l.allowTypo || l.allowTypo) ? v.algorithm : v.algorithmNoTypo)(e, o, e[0])) : null) : null
								},
								go: function (e, o, i) {
									if (!e) return n;
									var a = (e = v.prepareSearch(e))[0],
										r = i && i.threshold || l && l.threshold || -9007199254740991,
										t = i && i.limit || l && l.limit || 9007199254740991,
										d = (i && void 0 !== i.allowTypo ? i.allowTypo : !l || void 0 === l.allowTypo || l.allowTypo) ? v.algorithm : v.algorithmNoTypo,
										u = 0,
										f = 0,
										y = o.length;
									if (i && i.keys)
										for (var h = i.scoreFn || s, j = i.keys, p = j.length, b = y - 1; b >= 0; --b) {
											for (var w = o[b], k = new Array(p), x = p - 1; x >= 0; --x)(S = m(w, C = j[x])) ? (c(S) || (S = v.getPrepared(S)), k[x] = d(e, S, a)) : k[x] = null;
											k.obj = w;
											var E = h(k);
											null !== E && (E < r || (k.score = E, u < t ? (g.add(k), ++u) : (++f, E > g.peek().score && g.replaceTop(k))))
										} else if (i && i.key) {
											var C = i.key;
											for (b = y - 1; b >= 0; --b)(S = m(w = o[b], C)) && (c(S) || (S = v.getPrepared(S)), null !== (O = d(e, S, a)) && (O.score < r || (O = {
												target: O.target,
												...
												indexes: O.indexes,
												obj: w
											}, u < t ? (g.add(O), ++u) : (++f, O.score > g.peek().score && g.replaceTop(O)))))
										} else
										for (b = y - 1; b >= 0; --b) {
											var S, O;
											(S = o[b]) && (c(S) || (S = v.getPrepared(S)), null !== (O = d(e, S, a)) && (O.score < r || (u < t ? (g.add(O), ++u) : (++f, O.score > g.peek().score && g.replaceTop(O)))))
										}
									if (0 === u) return n;
									var I = new Array(u);
									for (b = u - 1; b >= 0; --b) I[b] = g.poll();
									return I.total = u + f, I
								},
								goAsync: function (o, i, a) {
									var r = !1,
										t = new Promise((function (t, g) {
											...
											var u = (o = v.prepareSearch(o))[0],
												f = d(),
												y = i.length - 1,
												h = a && a.threshold || l && l.threshold || -9007199254740991,
												j = a && a.limit || l && l.limit || 9007199254740991,
											...
											function k() {
												...
												var d = Date.now();
												if (a && a.keys)
													for (var l = a.scoreFn || s, x = a.keys, E = x.length; y >= 0; --y) {
														for (var C = i[y], S = new Array(E), O = E - 1; O >= 0; --O)(z = m(C, A = x[O])) ? (c(z) || (z = v.getPrepared(z)), S[O] = p(o, z, u)) : S[O] = null;
														S.obj = C;
														var I = l(S);
														if (null !== I && !(I < h) && (S.score = I, b < j ? (f.add(S), ++b) : (++w, I > f.peek().score && f.replaceTop(S)), y % 1e3 == 0 && Date.now() - d >= 10)) return void (e ? setImmediate(k) : setTimeout(k))
													} else if (a && a.key) {
														for (var A = a.key; y >= 0; --y)
															if ((z = m(C = i[y], A)) && (c(z) || (z = v.getPrepared(z)), null !== (M = p(o, z, u)) && !(M.score < h) && (M = {
																target: M.target,
																_targetLowerCodes: null,
																_nextBeginningIndexes: null,
																score: M.score,
																indexes: M.indexes,
																obj: C
															}, b < j ? (f.add(M), ++b) : (++w, M.score > f.peek().score && f.replaceTop(M)), y % 1e3 == 0 && Date.now() - d >= 10))) return void (e ? setImmediate(k) : setTimeout(k))
													} else
													for (; y >= 0; --y) {
														var z, M;
														if ((z = i[y]) && (c(z) || (z = v.getPrepared(z)), null !== (M = p(o, z, u)) && !(M.score < h) && (b < j ? (f.add(M), ++b) : (++w, M.score > f.peek().score && f.replaceTop(M)), y % 1e3 == 0 && Date.now() - d >= 10))) return void (e ? setImmediate(k) : setTimeout(k))
													}
												if (0 === b) return t(n);
												for (var L = new Array(b), P = b - 1; P >= 0; --P) L[P] = f.poll();
												L.total = b + w, t(L)
											}
											e ? setImmediate(k) : k()
										}));
								...
								algorithm: function (e, o, i) {
									for (var n = o._targetLowerCodes, t = e.length, s = n.length, m = 0, c = 0, d = 0, g = 0; ;) {
										if (i === n[c]) {
											if (a[g++] = c, ++m === t) break;
									...
									if (c !== s)
										for (; ;)
											...
											} else if (e[0 === u ? m : u === m ? m + 1 : u === m - 1 ? m - 1 : m] === n[c]) {
												if (r[f++] = c, ++m === t) {
													l = !0;
													break
												} ++c
									...
									for (var b = 0, w = -1, k = 0; k < t; ++k) w !== (c = j[k]) - 1 && (b -= c), w = c;
									for (l ? 0 !== u && (b += -20) : (b *= 1e3, 0 !== d && (b += -20)), b -= s - t, o.score = b, o.indexes = new Array(p), k = p - 1; k >= 0; --k) o.indexes[k] = j[k];
									return o
								},
								algorithmNoTypo: function (e, o, i) {
									for (var n = o._targetLowerCodes, t = e.length, s = n.length, m = 0, c = 0, d = 0; ;) {
										if (i === n[c]) {
											if (a[d++] = c, ++m === t) break;
											i = e[m]
										}
									...
									if (null === l && (l = o._nextBeginningIndexes = v.prepareNextBeginningIndexes(o.target)), (c = 0 === a[0] ? 0 : l[a[0] - 1]) !== s)
										for (; ;)
											if (c >= s) {
												if (m <= 0) break;
												--m, c = l[r[--u]]
									...
									for (var h = 0, j = -1, p = 0; p < t; ++p) j !== (c = f[p]) - 1 && (h -= c), j = c;
									for (g || (h *= 1e3), h -= s - t, o.score = h, o.indexes = new Array(y), p = y - 1; p >= 0; --p) o.indexes[p] = f[p];
									return o
								},
								...
								prepareNextBeginningIndexes: function (e) {
									for (var o = e.length, i = v.prepareBeginningIndexes(e), n = [], a = i[0], r = 0, t = 0; t < o; ++t) a > t ? n[t] = a : (a = i[++r], n[t] = void 0 === a ? o : a);
									return n
								},
								cleanup: t,
								new: u
			...
			class Wo {
				...
				render() {
					const e = Ce("div", "emoji-picker__search-not-found"),
						o = Ce("div", "emoji-picker__search-not-found-icon");
					this.iconUrl ? o.appendChild(Do(this.iconUrl)) : o.innerHTML = zo, e.appendChild(o);
					const i = Ce("h2");
			...
			class Ko {
				...
				render() {
					return this.searchContainer = Ce("div", "emoji-picker__search-container"), this.searchField = Ce("input", "emoji-picker__search " + this.options.inputClass), this.searchField.placeholder = this.i18n.search, this.searchContainer.appendChild(this.searchField), this.searchIcon = Ce("span", "emoji-picker__search-icon"), this.options.icons && this.options.icons.search ? this.searchIcon.appendChild(Do(this.options.icons.search)) : this.searchIcon.innerHTML = _o, this.searchIcon.addEventListener("click", (e => this.onClearSearch(e))), this.searchContainer.appendChild(this.searchIcon), this.searchField.addEventListener("keydown", (e => this.onKeyDown(e))), this.searchField.addEventListener("keyup", (e => this.onKeyUp(e))), this.searchContainer
				}
				onClearSearch(e) {
					e.stopPropagation(), this.searchField.value && (this.searchField.value = "", this.resultsContainer = null, this.options.icons && this.options.icons.search ? (Se(this.searchIcon), this.searchIcon.appendChild(Do(this.options.icons.search))) : this.searchIcon.innerHTML = _o, this.searchIcon.style.cursor = "default", this.events.emit("hideSearchResults"), setTimeout((() => this.searchField.focus())))
				}
				setFocusedEmoji(e) {
					if (this.resultsContainer) {
						const o = this.resultsContainer.querySelectorAll("." + Oe);
				...
				onKeyUp(e) {
					if ("Tab" !== e.key && "Shift" !== e.key)
						if (this.searchField.value) {
							this.options.icons && this.options.icons.clearSearch ? (Se(this.searchIcon), this.searchIcon.appendChild(Do(this.options.icons.clearSearch))) : this.searchIcon.innerHTML = Bo, this.searchIcon.style.cursor = "pointer";
							const e = Ho.go(this.searchField.value, this.emojiData, {
								allowTypo: !0,
								limit: 100,
								key: "name"
							}).map((e => e.obj));
							this.events.emit("hidePreview"), e.length ? (this.resultsContainer = new Vo(e, !0, this.events, this.options, !1).render(), this.resultsContainer && (this.resultsContainer.querySelector("." + Oe).tabIndex = 0, this.focusedEmojiIndex = 0, this.resultsContainer.addEventListener("keydown", (e => this.handleResultsKeydown(e))), this.events.emit("showSearchResults", this.resultsContainer))) : this.events.emit("showSearchResults", new Wo(this.i18n.notFound, this.options.icons && this.options.icons.notFound).render())
						} else this.options.icons && this.options.icons.search ? (Se(this.searchIcon), this.searchIcon.appendChild(Do(this.options.icons.search))) : this.searchIcon.innerHTML = _o, this.searchIcon.style.cursor = "default", this.events.emit("hideSearchResults")
				}
			}
			class Uo {
				constructor(e, o, i) {
				...
				getEmoji(e) {
					return this.popup.querySelectorAll("." + Oe)[e]
				}
				setFocusedEmoji(e) {
				...
				render() {
					this.popup = Ce("div", "emoji-picker__variant-popup");
					const e = Ce("div", "emoji-picker__variant-overlay");
					...
					const o = this.popup.querySelector("." + Oe);
					return this.focusedEmojiIndex = 0, o.tabIndex = 0, setTimeout((() => o.focus())), this.popup.addEventListener("keydown", (e => {
						"ArrowRight" === e.key ? this.setFocusedEmoji(Math.min(this.focusedEmojiIndex + 1, this.popup.querySelectorAll("." + Oe).length - 1)) : "ArrowLeft" === e.key ? this.setFocusedEmoji(Math.max(this.focusedEmojiIndex - 1, 0)) : "Escape" === e.key && (e.stopPropagation(), this.events.emit("hideVariantPopup"))
			...
			class Xo {
				...
				render() {
					const e = Ce("div", "emoji-picker__category-buttons");
					let o = this.options.showRecents ? ["recents", ...this.options.categories || Ee.categories] : this.options.categories || Ee.categories;
					return this.options.custom && (o = [...o, "custom"]), o.forEach((o => {
						const i = Ce("button", "emoji-picker__category-button");
						this.options.icons && this.options.icons.categories && this.options.icons.categories[o] ? i.appendChild(Do(this.options.icons.categories[o])) : i.innerHTML = Go[o], i.tabIndex = -1, i.title = this.i18n.categories[o], e.appendChild(i), this.buttons.push(i), i.addEventListener("click", (() => {
			...
			const $o = {};
			Ee.emoji.forEach((e => {
				let o = $o[Ee.categories[e.category]];
				o || (o = $o[Ee.categories[e.category]] = []), o.push(e)
			}));
			class Yo {
				constructor(e, o, i) {
					this.events = e, this.i18n = o, this.options = i, this.currentCategory = 0, this.headers = [], this.focusedIndex = 0, this.handleKeyDown = e => {
						...
						const i = Ce("h2", "emoji-picker__category-name");
						i.innerHTML = this.i18n.categories[e] || Jo.categories[e], this.emojis.appendChild(i), this.headers.push(i), this.emojis.appendChild(new Vo(o, !0, this.events, this.options, "recents" !== e).render())
					...
					}, this.emojisPerRow = i.emojisPerRow || 8, this.categories = i.categories || Ee.categories, i.showRecents && (this.categories = ["recents", ...this.categories]), i.custom && (this.categories = [...this.categories, "custom"])
				}
				updateRecents() {
				...
				render() {
					return this.container = Ce("div", "emoji-picker__emoji-area"), this.options.showCategoryButtons && (this.categoryButtons = new Xo(this.options, this.events, this.i18n), this.container.appendChild(this.categoryButtons.render())), this.emojis = Ce("div", "emoji-picker__emojis"), this.options.showRecents && ($o.recents = Fo()), this.options.custom && ($o.custom = this.options.custom.map((e => ({
						...e,
						custom: !0
					...
					})), this.emojis.addEventListener("keydown", this.handleKeyDown), this.events.on("categoryClicked", this.selectCategory), this.container.appendChild(this.emojis), this.container.querySelectorAll("." + Oe)[0].tabIndex = 0, this.container
				}
				reset() {
				...
				get focusedEmoji() {
					return this.currentCategoryEl.querySelectorAll("." + Oe)[this.focusedIndex]
				}
				get currentEmojiCount() {
					return this.currentCategoryEl.querySelectorAll("." + Oe).length
				}
				getEmojiCount(e) {
					return this.emojis.querySelectorAll(".emoji-picker__container")[e].querySelectorAll("." + Oe).length
				}
			...
			class ei {
				constructor(e = {}) {
					this.events = new x, this.publicEvents = new x, this.pickerVisible = !1, this.options = {
						...Qo,
						...e
				...
				buildPicker() {
					if (this.pickerEl = Ce("div", "emoji-picker"), this.updateTheme(this.theme), this.options.showAnimation || this.pickerEl.style.setProperty("--animation-duration", "0s"), this.options.emojisPerRow && this.pickerEl.style.setProperty("--emoji-per-row", this.options.emojisPerRow.toString()), this.options.rows && this.pickerEl.style.setProperty("--row-count", this.options.rows.toString()), this.options.emojiSize && this.pickerEl.style.setProperty("--emoji-size", this.options.emojiSize), this.options.showCategoryButtons || this.pickerEl.style.setProperty("--category-button-height", "0"), this.focusTrap = function (e, o) {
						var i = document,
							...
							t = {
								activate: function (e) {
									if (!r.active) {
										p(), r.active = !0, r.paused = !1, r.nodeFocusedBeforeActivation = i.activeElement;
								...
								unpause: function () {
									r.paused && r.active && (r.paused = !1, p(), m())
								}
							};
						return t;
						...
						function s(e) {
							if (r.active) {
								clearTimeout(f), c(), r.active = !1, r.paused = !1, b.deactivateTrap(t);
								var o = e && void 0 !== e.onDeactivate ? e.onDeactivate : a.onDeactivate;
								return o && o(), (e && void 0 !== e.returnFocus ? e.returnFocus : a.returnFocusOnDeactivate) && w((function () {
									var e;
						...
						function m() {
							if (r.active) return b.activateTrap(t), f = w((function () {
								k(g())
							})), i.addEventListener("focusin", l, !0), i.addEventListener("mousedown", u, {
								capture: !0,
								passive: !1
						...
						function c() {
							if (r.active) return i.removeEventListener("focusin", l, !0), i.removeEventListener("mousedown", u, !0), i.removeEventListener("touchstart", u, !0), i.removeEventListener("click", y, !0), i.removeEventListener("keydown", v, !0), t
						}
						...
						function l(e) {
							n.contains(e.target) || e.target instanceof Document || (e.stopImmediatePropagation(), k(r.mostRecentlyFocusedNode || g()))
						}
						...
						function v(e) {
							...
							(function (e) {
								...
								if (p(), e.shiftKey && e.target === r.firstTabbableNode) return e.preventDefault(), void k(r.lastTabbableNode);
						...
						function p() {
							var e = h(n);
							r.firstTabbableNode = e[0] || g(), r.lastTabbableNode = e[e.length - 1] || g()
						}
					...
					}), this.pickerContent = Ce("div", "emoji-picker__content"), this.options.plugins) {
						const e = Ce("div", "emoji-picker__plugin-container");
					...
					if (this.options.showSearch) {
						const e = new Ko(this.events, this.i18n, this.options, Ee.emoji, (this.options.categories || []).map((e => Ee.categories.indexOf(e)))).render();
						this.pickerEl.appendChild(e)
					}
					this.pickerEl.appendChild(this.pickerContent), this.emojiArea = new Yo(this.events, this.i18n, this.options), this.pickerContent.appendChild(this.emojiArea.render()), this.events.on("showSearchResults", (e => {
						Se(this.pickerContent), e.classList.add("search-results"), this.pickerContent.appendChild(e)
					})), this.events.on("hideSearchResults", (() => {
						this.pickerContent.firstChild !== this.emojiArea.container && (Se(this.pickerContent), this.pickerContent.appendChild(this.emojiArea.container)), this.emojiArea.reset()
					})), this.options.showPreview && this.pickerEl.appendChild(new Ae(this.events, this.options).render()), this.events.on("emoji", (({
						emoji: e,
						showVariants: o
					}) => {
						e.variations && o && this.options.showVariants ? this.showVariantPopup(e) : (setTimeout((() => this.emojiArea.updateRecents())), e.custom ? this.publicEvents.emit("emoji", {
							...
							name: e.name,
							custom: !0
						}) : "twemoji" === this.options.style ? xe.parse(e.emoji, {
							...Zo,
							callback: (o, i) => {
					...
					})), this.wrapper = Ce("div", "emoji-picker__wrapper"), this.wrapper.appendChild(this.pickerEl), this.wrapper.style.display = "none", this.options.zIndex && (this.wrapper.style.zIndex = this.options.zIndex + ""), this.options.rootElement && this.options.rootElement.appendChild(this.wrapper), this.observeForLazyLoad()
				}
				showVariantPopup(e) {
					const o = new Uo(this.events, e, this.options).render();
				...
				observeForLazyLoad() {
					this.observer = new IntersectionObserver((e => {
						Array.prototype.filter.call(e, (e => e.intersectionRatio > 0)).map((e => e.target)).forEach((e => {
							if (!e.dataset.loaded)
								if (e.dataset.custom) {
									const o = Ce("img", "emoji-picker__custom-emoji");
									o.src = e.dataset.emoji, e.innerText = "", e.appendChild(o), e.dataset.loaded = !0, e.style.opacity = 1
								} else "twemoji" === this.options.style && (e.innerHTML = xe.parse(e.dataset.emoji, Zo), e.dataset.loaded = !0, e.style.opacity = "1")
						}))
					}), {
						root: this.emojiArea.emojis
					}), this.emojiArea.emojis.querySelectorAll("." + Oe).forEach((e => {
				...
				hidePicker() {
					this.hideInProgress = !0, this.focusTrap.deactivate(), this.pickerVisible = !1, this.overlay && (document.body.removeChild(this.overlay), this.overlay = void 0), this.emojiArea.emojis.removeEventListener("scroll", this.emojiArea.highlightCategory), this.pickerEl.classList.add("hiding"), setTimeout((() => {
						this.wrapper.style.display = "none", this.pickerEl.classList.remove("hiding"), this.pickerContent.firstChild !== this.emojiArea.container && (Se(this.pickerContent), this.pickerContent.appendChild(this.emojiArea.container));
					...
					if (this.hideInProgress) setTimeout((() => this.showPicker(e)), 100);
						...
						if (this.pickerVisible = !0, this.wrapper.style.display = "block", window.matchMedia("screen and (max-width: 450px)").matches) {
							const e = window.getComputedStyle(this.pickerEl),
								...
								t = parseInt(e.width),
								s = n ? n / 2 - t / 2 : 0;
							this.wrapper.style.position = "fixed", this.wrapper.style.top = r + "px", this.wrapper.style.left = s + "px", this.wrapper.style.zIndex = "5000", this.overlay = Ce("div", "emoji-picker__overlay"), document.body.appendChild(this.overlay)
						} else "string" == typeof this.options.position ? this.popper = pe(e, this.wrapper, {
						...
						this.focusTrap.activate(), setTimeout((() => {
							document.addEventListener("click", this.onDocumentClick), document.addEventListener("keydown", this.onDocumentKeydown), this.pickerEl.querySelector(this.options.showSearch && this.options.autoFocusSearch ? ".emoji-picker__search" : `.${Oe}[tabindex="0"]`).focus()
			...
			const ii = {
				...
				any: function () {
					return ii.Android() || ii.BlackBerry() || ii.iOS() || ii.Opera() || ii.Windows()
				}
			},
				ni = document.querySelectorAll("[data-emoji-form]");
			if (ii.any() ? ni.forEach((e => {
			...
			})), (0, a.Z)(document.querySelectorAll('[data-autosize="true"]')), document.querySelectorAll('[data-theme-toggle="tab"]').forEach((e => {
				e.addEventListener("click", (o => {
					o.preventDefault(), new n.OK(document.querySelector(e.hash)).show()
				}))
			})), document.querySelectorAll('[data-bs-toggle="tooltip"]').forEach((e => {
				new n.u(e, {
					html: !0
				})
			})), document.querySelector(".chat-body-inner") && document.querySelector(".chat-body-inner")) {
				const ai = document.querySelector(".chat-footer");

				function ri() {
					const e = document.querySelector(".chat-body-inner");
					e && ai && e.setAttribute("style", `padding-bottom: ${Number(ai.offsetHeight)}px`)
				}
				new ResizeObserver(ri).observe(ai)
			}
			if (document.querySelector("[data-dropzone-area]")) {
				const ti = new oi.Dropzone("[data-dropzone-area]", {
					url: "post.php",
					clickable: "#dz-btn",
		...
		547: () => {
			const e = document.getElementById("modal-media-preview");
			e && e.addEventListener("show.bs.modal", (function (o) {
				let i = o.relatedTarget.getAttribute("data-theme-img-url");
				e.querySelector(".modal-preview-url").src = i
			}))
		},
		94: () => {
			const e = document.querySelectorAll("link[class=css-lt]"),
				o = document.querySelectorAll("link[class=css-dk]"),
				i = document.querySelectorAll(".switcher-btn"),
				n = document.querySelectorAll(".switcher-icon");

			function a() {
				console.log(localStorage.getItem("color-scheme"));
				return localStorage.getItem("color-scheme")
			}
			let r = a() ? a() : matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light";
			/*
			这里调用了函数 a() 来获取 localStorage 中的 "color-scheme" 值，如果该值存在（即不为 null 或 undefined），则使用该值作为 r 的值；否则，会使用 matchMedia("(prefers-color-scheme: dark)").matches 来检测用户的系统首选颜色方案，如果是暗色模式则设置为 "dark"，否则设置为 "light"。

			所以，如果 localStorage 中没有 "color-scheme" 值，且用户系统也没有设置首选颜色方案，那么默认的颜色方案会被设置为 "light"。
			*/
			console.log("check point 1: ", r);
			[...i].forEach((i => {
				i.addEventListener("click", (i => {
					[...n].forEach((e => {
						e.classList.contains("d-none") && (r = e.getAttribute("data-theme-mode")), e.classList.toggle("d-none")
					})), r && (function (e) {
						localStorage.setItem("color-scheme", e)

						// 验证写入是否成功
						const savedValue = localStorage.getItem("color-scheme");
						if (savedValue === e) {
							console.log("Color scheme successfully set to:", e);
						} else {
						...
						[...e].forEach((e => {
							e.media = "light" === i ? "all" : "not screen"
						})), [...o].forEach((e => {
							e.media = "dark" === i ? "all" : "not screen"
						}))
					}(r))
				}))
			})),
				function (e) {
					[...n].forEach((o => {
						...
						o.getAttribute("data-theme-mode") === e && o.classList.toggle("d-none")
					}))
				}(r)
		},
		866: () => {
	...
	n.m = o, e = [], n.O = (o, i, a, r) => {
		if (!i) {
			...
			for (d = 0; d < e.length; d++) {
				for (var [i, a, r] = e[d], s = !0, m = 0; m < i.length; m++)(!1 & r || t >= r) && Object.keys(n.O).every((e => n.O[e](i[m]))) ? i.splice(m--, 1) : (s = !1, r < t && (t = r));
				if (s) {
					e.splice(d--, 1);
					var c = a();
					void 0 !== c && (o = c)
		...
		for (var i in o) n.o(o, i) && !n.o(e, i) && Object.defineProperty(e, i, {
			enumerable: !0,
			get: o[i]
		})
	}, n.g = function () {
		...
		var o = (o, i) => {
			...
			for (o && o(i); c < t.length; c++) r = t[c], n.o(e, r) && e[r] && e[r][0](), e[r] = 0;
			return n.O(d)
		},
			i = self.webpackChunkmessenger = self.webpackChunkmessenger || [];
		i.forEach(o.bind(null, 0)), i.push = o.bind(null, i.push.bind(i))
	})();
	var a = n.O(void 0, [736], (() => n(984)));
	a = n.O(a)
})();